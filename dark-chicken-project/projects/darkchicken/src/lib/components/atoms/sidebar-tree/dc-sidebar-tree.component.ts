...
@Component({
  selector: 'dca-sidebar-tree',
  templateUrl: './dc-sidebar-tree.component.html',
  styleUrls: ['./dc-sidebar-tree.component.css']
})
export class DcSidebarTreeComponent implements OnChanges {

  @Input() treeData!: SidebarTreeModel[] | any[];
